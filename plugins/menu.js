...
⬣━〔Powered By ZyyXd〕━⬣
▌│█║▌║▌║║▌║▌║█│▌ `.trim(),
                        "footerText": "*group offc bot https://chat.whatsapp.com/Hoiw17HdXfMDV8Pagsi4UG*",
                        "buttonText": "««𝕄𝔼ℕ𝕌««",
                        ...
                        "sections": [
                            {
                                "rows": [{
                                    ...
                                    "title":      "|🖼️| ❯╾Daftar╼-",
                                    "description": "Daftar diri anda di Ex-Botz",
                                    "rowId": ".daftar"
                                }, {
 "title":      "|🎲| ❯╾Setelan group╼-",
                                    "description": "setelan group",
                                    "rowId": ".setelangrub"
                                }, {
"title":      "|🛒| ❯╾Store Menu╼-",
                                    "description": "store di Ex-Botz",
                                    "rowId": ".iklan"
                                }, {
  "title":  "|👩‍💻| ❯╾jadibot╼-",
                                    "description": "bergabung bersama bot Ex",
                                    "rowId": ".jadibot"
                                }, {
  "title":  "|🙇‍♂️| ❯╾group╼-",
                                    "description": "bergabung di grub bersama bot Ex",
                                    "rowId": ".gcbot"
                                }, {
  "title":  "|📒| ❯╾biodata owner╼-",
...
"title": "|🅿️|─────「 31 」",
                                    "description": "profile anda di Ex-Botz",
                                    "rowId": ".profile"
                                }, { 
                                    "title": "|👩‍⚖️|─────「 32 」",
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(thumbfoto)).buffer(), text.trim(), watermark, '𝐏𝐄𝐌𝐈𝐋𝐈𝐊 𝐁𝐎𝐓⌫', `${_p}owner`, '𝐓𝐔𝐓𝐎𝐑𝐈𝐀𝐋 𝐌𝐄𝐌𝐁𝐔𝐀𝐓 𝐁𝐎𝐓', `.carabuatbot`, m)
  } catch (e) {
